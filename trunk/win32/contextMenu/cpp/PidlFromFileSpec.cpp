...
static BOOL GetPidlAndShellFolder (LPCTSTR pszPath, IShellFolder** ppsfOut, LPITEMIDLIST* ppidlOut);


IShellFolder* ShellFolderPidlsFromFileSpec (LPCTSTR pszRelSpec, PidlVector& pidls)
{
	char* pszFullSpec;
